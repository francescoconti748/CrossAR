...
for idx_delta = 1:n_delta
    ...
    poles_x = ['[ 0.8, +', num2str(delta(idx_delta))  '; 0.8, -', num2str(delta(idx_delta)), ']' ];
    poles_y = ['[ 0.8, -', num2str(delta(idx_delta))  '; 0.8, +', num2str(delta(idx_delta)), ']' ];
...
%%
    ...
    legend( [scatter_obj_gt, scatter_obj_L1, scatter_obj_L2],{"GoundT", ['L = ' num2str(L(1))], ['L = ' num2str(L(2))]}, "Location", "southwest" )
